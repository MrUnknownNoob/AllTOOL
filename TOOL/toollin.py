...
if(select == 1):
    ...
    if(select == 1):
        a = raw_input("Enter you Sentence: ")
    ...
    select = input("Select Any Thing:")
    if(select == 1):
        a = raw_input("Enter your Anything::")
        print("Your Character is:", len(a))

    elif(select == 2):
        a = raw_input("Select Your File Path::")
        b = open(a, 'r')
        count = 0
        for line in b:
            words = line.split(" ")
    ...
    a = raw_input("Enter ANy Thing:")
    b = raw_input("What is your Target word:")
    c = raw_input("What Word to you replace:")
    ...
    print 'There are ::-'
    print '[+] Lines are :',numlines
    print '[+] Words are :',numwords
    print '[+] Character  are :',numchar
    ...
    if(select==1): 
        hashcode = raw_input("Enter your hash::")
        filepath = raw_input("Enter the File Path :")

        def hash(inputhash):

            try:
                passfile = open(filepath, "r").readlines()  
            except:
    ...
    ch = raw_input("Press 'E' to Encrypted Or 'D' to Decypted :")
    if ch == 'E' or ch == 'e':
        texttoencrypted = raw_input("Enter Some Text to Encrypt :").upper()
        encryptor(texttoencrypted)
    else :
        texttodecrypted = raw_input("Enter Morse code to Decrypt :")
